...
const SVGTreeView = ({rootNodes, onNodeSelect, onMoveNodeUp, onMoveNodeDown, onDeleteNode, onNewElement}: SVGTreeViewProps) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <MenuItem onClick={() => {onNewElement('rect'); handleClose();}}>rect</MenuItem>
                    <MenuItem onClick={() => {onNewElement('circle'); handleClose();}}>circle</MenuItem>
                </Menu>
            </Box>
        </Box>
    )
